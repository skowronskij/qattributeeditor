...
from .gui.main_dock import QAttributeEditorDockWidget
import os.path


class QAttributeEditor:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'QAttributeEditor_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&qAttributeEditor')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'QAttributeEditor')
        self.toolbar.setObjectName(u'QAttributeEditor')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QAttributeEditor', message)
